                        ...
                        {!isRequesting &&
                            <form onSubmit={(e) => this._formOnSubmit(e)} > 
                                <div className="form-group">
                                  <br/>
                                  <div className="input-group mb-3 col-9" className="namatagihan">
                                    <input type="text" className="form-control" placeholder="Masukan Nama Tagihan" required style={{textalign:'center'}} ref="name" onChange={(e)=>{
                                  ...
                                  <br/>
                                  <div className="input-group mb-3 col-9" className="amount">
                                  <Cleave
                                    ref="amount"
                                  ...
                                  <br/>
                                  <div className="input-group mb-3 col-7" className="noref">
                                   ...
                                   <input type="text" className="form-control" placeholder="Masukan No.Ref Tagihan" required style={{textalign:'center'}} ref="text" onChange={(e)=>{
