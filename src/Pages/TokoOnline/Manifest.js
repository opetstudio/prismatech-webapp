...
export const fields = '_id,name,slug,status,website,facebook,instagram,youtube,description,created_at,updated_at,owner{full_name},created_by{full_name},updated_by{full_name}'
