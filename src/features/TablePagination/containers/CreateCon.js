...
function CardBody ({ userPrivileges, tablepaginationOnChangeForm, payload, child }) {
  return child(tablepaginationOnChangeForm, payload, userPrivileges)
}
const CreateCon = (props) => {
  ...
  //   }
  // }, [paginationConfig.serviceName, tablepaginationResetForm])
        ...
        >
          <div className='card'>
            ...
            <div className='card-body'>
              {child && <CardBody userPrivileges={userPrivileges} child={child} payload={payload} tablepaginationOnChangeForm={tablepaginationOnChangeForm} />}
